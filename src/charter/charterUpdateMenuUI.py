...
class CharterUpdateMenuUI:
    def __init__(self, root, charter, id):
        ...
        self.label_issuance_date.grid(row=1, column=0, padx=10, pady=5)
        self.entry_issuance_date = tkinter.Entry(root)
        self.entry_issuance_date.grid(row=1, column=1, padx=10, pady=5)

        self.label_content = tkinter.Label(root, text="Obsah:")
        self.label_content.grid(row=2, column=0, padx=10, pady=5)
        self.entry_content = tkinter.Entry(root)
        self.entry_content.grid(row=2, column=1, padx=10, pady=5)
        ...
        self.label_country.grid(row=4, column=0, padx=10, pady=5)
        self.entry_country = tkinter.Entry(root)
        self.entry_country.grid(row=4, column=1, padx=10, pady=5)

        self.label_period = tkinter.Label(root, text="Období:")
        self.label_period.grid(row=5, column=0, padx=10, pady=5)
        self.entry_period = tkinter.Entry(root)
        self.entry_period.grid(row=5, column=1, padx=10, pady=5)
